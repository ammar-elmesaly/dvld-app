...
export default function ManageApplicationsTable<RowType, RowActionType>({
  ...
  return (
    <Table
    ignoreColumns={['application_id', 'applicant_person_id', 'license_id', 'license_class_id', 'application_fees', 'paid_fees', 'retake_test_fees', 'created_by_user_name', 'application_type_name']}
